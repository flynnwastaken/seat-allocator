...
state_pops = {
  ...
  "Connecticut" => 3_608_298, "Delaware" => 990_837,
  "District of Columbia" => 691_533, "Florida" => 21_570_527,
  ...
  "Puerto Rico" => 3_285_874, "Rhode Island" => 1_098_163,
  "South Carolina" => 5_124_712, "South Dakota" => 887_770,
  "Tennessee" => 6_916_897, "Texas" => 29_183_290, "Utah" => 3_275_252,
  "Vermont" => 643_503, "Virginia" => 8_654_542, "Washington" => 7_715_946,
  "West Virginia" => 1_795_045, "Wisconsin" => 5_897_473, "Wyoming" => 577_719
}
...
puts %q{
  The population of the USA at the last census in 2020 was 335,085,841.
  ...
  if seatsquery == 1
    puts %q{
      How many seats do you want the House to have?
        ...
        580 (the "Wyoming Rule")
        1_700 (Madisonian)
        11_170 (Constitutional maximum)
    }
    prompt
    ...
    puts %q{
      How many people does the average representative represent?
        Some interesting numbers:
        770_312 (the current average for 435 seats)
